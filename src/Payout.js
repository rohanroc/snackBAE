    ...
    return (
        <>
            ...
            <div className="flex">
                ...
                <div className='bg-gray-100 md:overflow-hidden'>
                    ...
                    <div className='w-[1155px] h-[650px] bg-[#FFFFFF] m-auto rounded-lg md:h-[1150px]'>
                        ...
                        <hr className='w-[1140px] m-auto'></hr>

                        <div className='ml-10 my-6 md:flex md:flex-col md:ml-5'>
                            <span className='font-bold ml-10 md:ml-4'>Brand Logo</span>
                            <div className='my-5 space-x-4 ml-10 flex mt-5 md:ml-4'>
                                <img src={fodo} alt='Fodoos' className='w-[85px] rounded-3xl' ></img>
                                <button className='border-2 px-5 py-1.5 bg-[#004AAD] text-white border-[#004AAD] rounded-xl font-semibold my-6'>Save</button>
                                <button className='border-2 px-5 py-1.5 hover:bg-[#004AAD] hover:text-white text-[#004AAD] border-[#004AAD] rounded-xl font-semibold my-6'>Change</button>

                            </div>

                            <div className='flex space-x-5 md:flex-col md:space-x-2'>
                                <div className='w-72 ml-2 mt-7'>
                                    <label for="email" class="block text-md font-semibold leading-6 text-gray-900">Brand Name</label>
                                    <div class="mt-2">
                                ...
                                <div className='w-72 mt-7'>
                                    <label for="email" class="block text-md font-semibold leading-6 text-gray-900">Email Address</label>
                                    <div class="mt-2">
                                ...
                                <div className='w-72 mt-7'>
                                    <label for="email" class="block text-md font-semibold leading-6 text-gray-900">Contact Number</label>
                                    <div class="mt-2">
                                        <input id="c" name="c" type="number" autocomplete="c" required class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-[#FFD628] sm:text-sm sm:leading-6" />
                                    </div>
                                </div>
                            </div>
                            <div className='flex space-x-5 md:flex-col md:space-x-2'>
                                <div className='w-72 ml-2 mt-7'>
                                    <label for="email" class="block text-md font-semibold leading-6 text-gray-900">Contact Person</label>
                                    <div class="mt-2">
                                        <input id="cn" name="cn" type="text" autocomplete="cn" required class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-[#FFD628] sm:text-sm sm:leading-6" />
                                    </div>
                                </div>
                                <div className='w-72 mt-7'>
                                    <label for="email" class="block text-md font-semibold leading-6 text-gray-900">Outlet Address</label>
                                    <div class="mt-2">
                                        <input id="" name="" type="text" autocomplete="" required class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-[#FFD628] sm:text-sm sm:leading-6" />
                                    </div>
                                </div>
                                <div className='w-72 mt-7'>
                                    <label for="hotel" class="block text-md font-semibold leading-6 text-gray-900">Select an option</label>
                                    <select id="hotel" class="block w-full rounded-md border-0 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-[#FFD628] sm:text-sm sm:leading-6 mt-2 py-2">
                                        <option selected>Restaurant</option>
                                        <option value="hotel">Hotel</option>
                                        <option value="hs">Home Stay</option>
                                    </select>
                                </div>
                            </div>
                            <div className='flex space-x-5 md:flex-col md:space-x-2'>
                                <div className='w-72 mt-7 md:ml-2'>
                                    <label for="hotel" class="block text-md font-semibold leading-6 text-gray-900">Cuisines served</label>
                                    <select id="hotel" class="block w-full rounded-md border-0 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-[#FFD628] sm:text-sm sm:leading-6 mt-2 py-2">
                                        <option selected>Indian</option>
                                        <option value="hotel">Chinese</option>
                                        <option value="hs">Italian</option>
                                    </select>
                                </div>
                                <div className='w-72 mt-7'>
                                    <label for="email" class="block text-md font-semibold leading-6 text-gray-900">Instagram Link(Optional)</label>
                                    <div class="mt-2">
                                        <input id="IFSC" name="IFSC" type="url" autocomplete="IFSC" required class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-[#FFD628] sm:text-sm sm:leading-6" />
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className='w-[1155px] h-[190px] bg-[#FFFFFF] m-auto rounded-lg border-black border-2 my-8 flex md:h-28 md:w-[90%]'>
                        <div className='ml-14 text-center mt-5 md:ml-3 md:w-[40%]'>
